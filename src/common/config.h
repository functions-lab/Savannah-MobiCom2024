 ...
 public:
  ...
  inline size_t ModOrder(Direction dir) const {
    if (dir == Direction::kUplink) {
      if (ul_modulation_ == "QPSK") { return 2; }
      else if (ul_modulation_ == "16QAM") { return 4; }
      else if (ul_modulation_ == "64QAM") { return 6; }
      return 0;
    } else {
      if (dl_modulation_ == "QPSK") { return 2; }
      else if (dl_modulation_ == "16QAM") { return 4; }
      else if (dl_modulation_ == "64QAM") { return 6; }
      return 0;
    }
  }
